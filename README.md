...
[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](https://github.com/K-Dense-AI/ai-research-engineer/pulls)
...
uvx ai-research-engineer --mode simple "your query here"
```
...
ai-research-engineer "Compare datasets" --mode orchestrated -f data1.csv -f data2.csv --working-dir ./my_analysis

# Directory upload (recursive)
ai-research-engineer "Analyze all data" --mode orchestrated --files data_folder/
```
...
ai-research-engineer "Write a Python script to parse CSV files" --mode simple

# Question answering
ai-research-engineer "Explain how gradient boosting works" --mode simple

# Fast analysis with temporary directory
ai-research-engineer "Quick data exploration" --mode simple --files data.csv --temp-dir
```
...
ai-research-engineer "Temporary analysis" --mode simple --files data.csv --working-dir ./temp --keep-files=false
```
...
```bash
# Clone repository
git clone https://github.com/K-Dense-AI/ai-research-engineer.git
...
2. **Create GitHub release:**
   - Go to https://github.com/K-Dense-AI/ai-research-engineer/releases/new?tag=v0.2.0
   - Click "Generate release notes" for automatic changelog
   - Publish release
   - Package automatically publishes to PyPI

**One-time PyPI Setup:** Configure [trusted publishing](https://docs.pypi.org/trusted-publishers/) on PyPI with repo `K-Dense-AI/ai-research-engineer` and workflow `pypi-publish.yml`.
...
- GitHub Issues: [Report bugs or request features](https://github.com/K-Dense-AI/ai-research-engineer/issues)
...
- Documentation: [Full documentation](https://github.com/K-Dense-AI/ai-research-engineer/blob/main/docs)
...
[![Star History Chart](https://api.star-history.com/svg?repos=K-Dense-AI/ai-research-engineer&type=date&legend=top-left)](https://www.star-history.com/#K-Dense-AI/ai-research-engineer&type=date&legend=top-left)
