...
def main(
    ...
    Examples:
        ...
        Use temporary directory (auto-cleanup):
            ai-research-engineer "Quick analysis" --mode simple --files data.csv --temp-dir

        Custom working directory:
            ai-research-engineer "Process data" --mode orchestrated --files data.csv --working-dir ./my_analysis
    ...
    if not query:
        if not sys.stdin.isatty():
            ...
            click.echo("Error: No query provided. Use 'ai-research-engineer \"your query\"' or pipe input.", err=True)
            sys.exit(1)
    ...
    try:
        ...
        # Add console handler only to ai_research_engineer loggers
        app_logger = logging.getLogger('ai_research_engineer')
